...
storiesOf('WithLoading', module)
  ...
  .addWithJSX('isLoading 에제', ()=> (
      <div>
          <ButtonWithLoading isLoading>안녕하세요</ButtonWithLoading>
          <TextWithLoading isLoading>안녕하세요</TextWithLoading>
      </div>
  ))
  .addWithJSX('loading 메시지 수정', ()=> (
    <div>
        <ButtonWithLoading isLoading loadingMessage = "로딩중이긴 합니다.">안녕하세요</ButtonWithLoading>
        <TextWithLoading isLoading loadingMessage =  "로딩중이긴 합니다.">안녕하세요</TextWithLoading>
    </div>
));
